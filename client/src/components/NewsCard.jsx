...
const NewsCard = ({ news }) => {
    ...
    // Feed Style Layout for Editorial Category
    if (news.category === 'Editorial') {
        return (
            <div className="editorial-feed-card" style={{ background: 'var(--bg-secondary)', padding: '2rem', borderRadius: '1rem', marginBottom: '1.5rem', border: '1px solid var(--border-color)', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
                <h2 style={{ fontSize: '1.75rem', fontWeight: '800', color: 'var(--text-primary)', marginBottom: '1rem', lineHeight: '1.3' }}>
                    {news.title}
                </h2>
                ...
                <div style={{ color: 'var(--text-primary)', lineHeight: '1.8', fontSize: '1.1rem', marginBottom: '1.5rem' }}>
                    {news.summary && (
                        <p style={{ fontWeight: '600', fontStyle: 'italic', marginBottom: '1.5rem', color: 'var(--text-secondary)', borderLeft: '4px solid var(--primary-color)', paddingLeft: '1rem' }}>
                            {news.summary}
                        </p>
                    )}
                    {news.content && (
                        <div className="editorial-full-text">
                            {news.content.split('\n').map((paragraph, index) => (
                ...
                <div className="news-card-footer" style={{ borderTop: '1px solid var(--border-color)', paddingTop: '1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div className="news-card-category" style={{ background: 'var(--primary-dark)', color: 'var(--primary-color)' }}>
                        EDITORIAL
                    </div>
